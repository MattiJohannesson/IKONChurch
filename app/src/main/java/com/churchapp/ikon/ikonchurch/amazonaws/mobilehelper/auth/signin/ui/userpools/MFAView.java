...
public class MFAView extends LinearLayout {
    ...
    private void setupVerifyButtonColor() {
        ...
        confirmButton.setBackgroundDrawable(
            DisplayUtils.getRoundedRectangleBackground( UserPoolFormConstants.FORM_BUTTON_CORNER_RADIUS, UserPoolFormConstants.FORM_BUTTON_COLOR));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int maxWidth = Math.min((int)(parentWidth * UserPoolFormConstants.FORM_SIDE_MARGIN_RATIO), UserPoolFormConstants.MAX_FORM_WIDTH_IN_PIXELS);
