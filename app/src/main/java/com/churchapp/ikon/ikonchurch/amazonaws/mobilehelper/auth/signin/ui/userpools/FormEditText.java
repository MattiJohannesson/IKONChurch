...
public class FormEditText extends LinearLayout {
    ...
    private static final int SHOW_PASSWORD_TOP_MARGIN = DisplayUtils.dp(-5); // float the show box up.
    ...
    public FormEditText(Context context, int inputType, final String fieldName) {
        ...
        textView.setText(fieldName.toUpperCase());
        ...
        editText.setPadding(0, DisplayUtils.dp(2), 0, DisplayUtils.dp(2) + EDIT_VIEW_BOTTOM_PADDING);
        ...
        editText.addTextChangedListener(new TextWatcher() {
            private void handleFloatingTextVisibility() {
                if (editText.getText().length() == 0) {
                    ...
                    editText.setPadding(0, DisplayUtils.dp(1), 0, DisplayUtils.dp(3) + EDIT_VIEW_BOTTOM_PADDING);
                    if (showPasswordToggleTextView != null) {
