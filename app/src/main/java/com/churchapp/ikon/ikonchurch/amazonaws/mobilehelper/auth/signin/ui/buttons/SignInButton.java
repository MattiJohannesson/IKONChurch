package com.churchapp.ikon.ikonchurch.amazonaws.mobilehelper.auth.signin.ui.buttons;
//
...
/* package */ class SignInButton extends LinearLayout {
    ...
    private Drawable getButtonBackground(final int buttonFaceColor) {
        ...
        final ShapeDrawable insetBackgroundDrawable =
            DisplayUtils.getRoundedRectangleBackground(cornerRadius, buttonFaceColor);
        ...
        outerShadowTopDrawable.setCornerRadius( DisplayUtils.dp(cornerRadius));
        ...
        outerShadowBottomDrawable.setCornerRadius( DisplayUtils.dp(cornerRadius));
